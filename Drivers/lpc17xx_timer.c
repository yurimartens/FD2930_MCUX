...
static uint32_t converPtrToTimeNum (TIM_TypeDef *TIMx);
 ...
 * @param[in]	TIMx Pointer to TIM_TypeDef, should be:
 * 				- TIM0: TIMER0 peripheral
 * 				- TIM1: TIMER1 peripheral
 * 				- TIM2: TIMER2 peripheral
 * 				- TIM3: TIMER3 peripheral
 * @return 		The timer number (0 to 3) or -1 if register pointer is bad
 **********************************************************************/
uint32_t converPtrToTimeNum (TIM_TypeDef *TIMx)
{
	uint32_t tnum = -1;
